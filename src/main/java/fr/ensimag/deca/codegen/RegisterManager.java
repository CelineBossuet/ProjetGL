...
/**
 * Fichier permetant de gérer les Registres pour pouvoir les alloc et avoir le
 * current
 * 
 * @author gl13
 * @date 10/01/2022
...
public class RegisterManager {
     ...
     *
     * @return reg le registre allocated. A ne pas utiliser par qqun d'autre tant
