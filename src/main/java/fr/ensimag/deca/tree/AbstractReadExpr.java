...
public abstract class AbstractReadExpr extends AbstractExpr {
    ...
    protected GPRegister codeGenReg(DecacCompiler compiler) {
        ////redéfinition de la méthode car il faut pouvoir utiliser geneInstru() de AbstractReadExpr
        //d'apres exemple p19 on doit pouvoir généré les instructions RINT (ou RFLOAT), BOV io_error et LOAD
